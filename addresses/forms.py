...
class AddressForm(forms.ModelForm):
    ...
    city                    = forms.CharField(widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Your City", "value": "Biñan", "readonly": "readonly"}))
    country                 = forms.CharField(widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Your Country", "value": "Philippines", "readonly": "readonly"}))
